# -*- coding: utf-8 -*-
"""
Created on Wed Nov 22 15:37:26 2023
...
Problem Statement: - 
A retail store in India, has its transaction data, and it 
would like to know the buying pattern of the consumers in
 its locality, you have been assigned this task to provide
 the manager with rules on how the placement of products
 needs to be there in shelves so that it can improve the 
 buying patterns of consumes and increase customer footfall. 
transaction_retail.csv
"""
"""
Business Objective 
Minimize : Mismatch of buying pattern
Maximaze : TO increase the Sale of products.
Business constraints:- Need to collect proper data of interest of 
customers in particular product.
"""
"""
Data Dictionary
Unstructured Data 
